    ...
    render (){
        return (
            <div class="addedDetail paddX15 disF">
                    ...
                    <span>{this.props.val.EmployerName.EmployerName}, Full Time, {this.props.val.StartDate.StartDate.split("-")[0]} - {this.props.val.CurrentlyWorking.CurrentlyWorking===false?this.props.val.EndDate.EndDate.split("-")[0]:'currently working'}</span>
                    </div>
